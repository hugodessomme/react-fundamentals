...
J'ai appris à créer des composants React, d'abord avec une simple fonction
retournant du JSX, puis avec un tag custom et valider les propriétés passées
avec `prop-types`.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=04%3A%20Creating%20custom%20components&em=hdessomme%40gmail.com).
