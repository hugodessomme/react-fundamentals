...
J'ai appris à configurer un formulaire simple avec des champs "contrôlés" et
"non-contrôlés". Aussi, j'ai appris à utiliser les hooks `useRef` et `useState`.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=06%3A%20Forms&em=hdessomme%40gmail.com).
